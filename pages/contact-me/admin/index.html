    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-8 login-box">
                ...
                <div class="col-lg-12 login-title">Welcome back Estif</div>

                <div class="col-lg-12 login-form">
                    <div class="col-lg-12 login-form">
                        <form method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
                            <div class="form-group">
                                <label class="form-control-label email-label">Email</label>
                            ...
                            <div class="col-lg-12 loginbttm">
                                ...
                                <div class="col-lg-12 text-center login-btm login-button">
                                    <button id="login-btn" type="submit" name="login" class="btn btn-outline-primary">LOGIN</button>
                                </div>
                            </div>
                        </form>
                    </div>
